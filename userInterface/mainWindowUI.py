...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_9.setText(_translate("MainWindow", "图像分割功能"))
        self.pushButton_10.setText(_translate("MainWindow", "图像检测功能"))
        self.pushButton_11.setText(_translate("MainWindow", "图像特征匹配"))
        self.pushButton_12.setText(_translate("MainWindow", "人脸识别检测"))
